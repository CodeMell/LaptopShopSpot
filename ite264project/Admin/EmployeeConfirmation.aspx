<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EmployeeConfirmation.aspx.cs" Inherits="ite264project.Admin.EmployeeConfirmation" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <div class="panel panel-danger">
        <div class="panel-heading text-center">
            <h1>Employee Registration Confirmation</h1>
        ...
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="col-md-10 col-lg-10">
                    <asp:Label runat ="server" ID="lblHireDate" Text=""></asp:Label>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-10 col-lg-10">
                    <asp:Label runat ="server" ID="lblTermDate" Text=""></asp:Label>
                </div>
            </div>
